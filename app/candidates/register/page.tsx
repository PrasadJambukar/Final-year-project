  ...
  return (
    <ProtectedRoute>
      <div className="container mx-auto px-6 py-16 hexagon-grid">
        ...
        <Card className="max-w-3xl mx-auto blockchain-card">
          <CardHeader>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    ...
                    required
                    className="min-h-[100px] blockchain-input"
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    ...
                    required
                    className="min-h-[150px] blockchain-input"
                  />
                </div>
                ...
                <Button type="submit" className="w-full blockchain-button">
                  Submit Candidacy
                </Button>
              </form>
            ) : (
