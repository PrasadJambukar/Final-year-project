    ...
    resultDeclared && (
      <div className="container mx-auto px-6 py-16 hexagon-grid">
        <div className="max-w-4xl mx-auto">
          ...
          {winner && (
            <Card className="mb-8 bg-primary/5 border-primary blockchain-gradient-border">
              <div className="blockchain-gradient-border-inner">
                <CardHeader>
                  <CardTitle className="text-center text-2xl">Winner</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="flex items-center gap-6 justify-center">
                    <div className="relative w-32 h-32 rounded-full overflow-hidden blockchain-pulse">
                      <Image
                        src={winner.otherDataUrl}
                        alt={winner.name}
                        fill
          ...
          <div className="space-y-6">
            {results.map((candidate, index) => (
              <Card key={candidate.id} className="blockchain-card">
                <CardContent className="p-6">
                  ...
                  <div className="space-y-2">
                    <Progress
                      ...
                      className="blockchain-progress h-2"
                    >
                      <div
                        className="blockchain-progress-bar"
